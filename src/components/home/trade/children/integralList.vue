                    ...
                    <div class="order_z" v-for="item in orderData" :key="item.id">
                        <div class="order_number">
                            ...
                            <div class="delivery_btn fr">
                                <el-button size="mini" @click="getOrderDetail(item)">查看</el-button>
                            </div>
                            <span class="black order_time">订单号: {{item.order_sn}} &nbsp;&nbsp;下单时间:
...
export default {
    ...
    methods: {
        ...
        getOrderDetail(data) {
            AbstractLogic.getInstance(data).jump(this.$router, 'orderIntegral');
        },
        //单选
        radio(index) {
